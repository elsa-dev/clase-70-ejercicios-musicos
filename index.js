...
//3 const artistasPorEdad = artistas.filter ((artista) => {
//   return artista.edad === 30
// })

// console.log(artistasPorEdad(30, artistas))

//4 `artistasConMasDiscosQue`, que tome por parámetro "cantidadDeDiscos" y un array de artistas y devuelva un array con les artistas que tiene más de esa cantidad de discos, ordenados de mayor a menor según cantidad de discos

const artistasConMasDiscosQue = (cantidadDeDiscos, array) => {
  return array.filter( (artista) => { 
  ...
  .sort( (a,b) => {
    ...
    else if(b.discos.length > a.discos.length) {
      return 1
    } else {
      return 0
    }
...
// console.log(artistasConMasDiscosQue(5,artistas))


//5 `artistaConMasEntradasVendidas`, que tome por parámetro un array de artistas y devuelva el objeto artista que vendió más entradas en su último recital
...
//6 `artistaConMayorRecaudacion`, que tome por parámetro un array de artistas y devuelva el objeto artista que más recaudó en su último recital (entradasVendidas * costoEntradas)

//7 `artistasConDiscoEnAnio`, que tome por parámetro un parámetro "anio" y un array de artistas, y devuelva un array con los artistas que tengan publicado al menos un disco en dicho año

//8 `artistaConMasCopias`, que reciba como parametro un array de artistas y devuelva el objeto artista que más copias de discos en total vendió

//9 `cantidadDeArtistasPorInstrumento`, que tome por parámetro un array de artistas y devuelva un objeto donde cada "instrumento" es una propiedad y su valor la cantidad de artistas que tocan dicho instrumento

//10 `cantidadDeArtistasPorGenero`, que tome por parámetro un array de artistas y devuelva un objeto donde cada "género" es una propiedad y su valor la cantidad de artistas de dicho género
...
const alumnas2 = [...alumnas].sort();
// console.log(alumnas2)
// console.log(alumnas)
